...
# In this code, errors has the truth value True because it's a non-zero number,   <<<------------bizu
# so the error message is printed. This is a nice, succinct way of writing an if statement.


## ----------- Exemple
points = 199  # use this as input for your submission
# establish the default prize value to None
prize = None
# use the points value to assign prizes to the correct prize names
if points <= 50:
    prize = 'wooden rabbit'
if 150 <= points <= 180:                                # <<< ----- bizu
...
if prize:
    result = print("Congratulations! You won a {}!".format(prize))
else:
    result = print("Oh dear, no prize this time.")
